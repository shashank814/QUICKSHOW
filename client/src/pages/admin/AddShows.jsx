...
const AddShows = () => {
  ...
  return nowPlayingMovies.length > 0 ? (
    <>
       ...
       {/* Date & Time Selection */}
       <div className='mt-6'>
         <label className='block text-sm gap-5 font-medium mb-2'>Select Date and Time</label>
         <div className='inline-flex gap-5 border border-gray-600 p-1 pl-3 rounded-lg'>
            ...
            <button onClick={handleDateTimeAdd} className='bg-primary/80 text-white px-3 py-2 textsm rounded-lg hover:bg-primary cursor-pointer'>Add Time</button>
         </div>
       </div>
