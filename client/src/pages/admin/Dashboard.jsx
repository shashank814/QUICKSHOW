import { ChartLineIcon, CircleDollarSign, icons, PlayCircleIcon, StarIcon, UsersIcon } from 'lucide-react';
...
const Dashboard = () => {
    ...
    const dashboardCards = [
        ...
        { title: "Total Revenue", value: typeof dashboardData.totalRevenue === "number" ? currency + dashboardData.totalRevenue.toFixed(2) : currency + "0.00", icon: CircleDollarSign },
            ...
            <div key={show._id} className='w-55 rounded-lg overflow-hidden h-full pb-3 bg-primary/10 border border-primary/20 hover:-translate-y-1 transition duration-300'>
                ...
                <div className='flex items-center justify-between px-2'>
                    ...
                    <p className='flex items-center gap-1 text-sm text-gray-400 mt-1 pr-1'>
                        ...
                        {typeof show.movie.vote_average === 'number' ? show.movie.vote_average.toFixed(1) : 'N/A'}
